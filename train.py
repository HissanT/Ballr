...
PRESETS = {
    ...
    "v5-tune-cleaned-repro": {
        "weights": str(model_path("yolo11n.pt")),
        "data": str(training_path("dataset_prepared_v4_tune_cleaned", "data.yaml")),
        "epochs": 90,
        "batch": 8,
        "imgsz": 768,
        "name": "ballr_v5_tune_cleaned_repro",
        "optimizer": "AdamW",
        "lr0": 0.0008,
        "lrf": 0.01,
        "warmup_epochs": 3,
    ...
    "v5-cleaned-final-repro": {
        "weights": str(model_path("ballr_v5_tune_cleaned.pt")),
        "data": str(training_path("dataset_prepared_v5_all", "data.yaml")),
        "epochs": 15,
        "batch": 8,
        "imgsz": 768,
        "name": "ballr_v5_cleaned_final_repro",
        "optimizer": "AdamW",
        "lr0": 0.0002,
        "lrf": 1.0,
        "warmup_epochs": 1,
    ...
    "v5-768-heldout": {
        "weights": str(model_path("ballr_v5_cleaned_final.pt")),
        "data": str(training_path("dataset_prepared_v5_eval", "data.yaml")),
        "epochs": 60,
        "batch": 8,
        "imgsz": 768,
        "name": "ballr_v5_768_heldout",
        "optimizer": "AdamW",
        "lr0": 0.0005,
        "lrf": 0.01,
        "warmup_epochs": 3,
    ...
    "v5-768-heldout-aug": {
        "weights": str(model_path("ballr_v5_cleaned_final.pt")),
        "data": str(training_path("dataset_prepared_v5_eval_aug", "data.yaml")),
        "epochs": 70,
        "batch": 8,
        "imgsz": 768,
        "name": "ballr_v5_768_heldout_aug",
        "optimizer": "AdamW",
        "lr0": 0.0005,
        "lrf": 0.01,
        "warmup_epochs": 3,
    ...
    "v6-temporal-768": {
        "weights": str(model_path("ballr_v5_cleaned_final.pt")),
        "data": str(training_path("dataset_prepared_v6_temporal_768", "data.yaml")),
        "epochs": 70,
        "batch": 8,
        "imgsz": 768,
        "name": "ballr_v6_temporal_768",
        "optimizer": "AdamW",
        "lr0": 0.0005,
        "lrf": 0.01,
        "warmup_epochs": 3,
...
def main() -> None:
    ...
    bootstrap.add_argument(
        ...
        default="custom",
        help="Training preset. Use v5-768-heldout, v5-768-heldout-aug, then v6-temporal-768 for the gray triplet model.",
    )
